...
OLD_PROXIMITY_LEFT = 0
OLD_PROXIMITY_RIGHT = 0
...
function step()
	...
	if OLD_PROXIMITY_RIGHT > 0.95 and robot.proximity[21].value == 0 then
		proximity_right = OLD_PROXIMITY_RIGHT
	else 
		OLD_PROXIMITY_RIGHT = robot.proximity[21].value
		proximity_right = robot.proximity[21].value
	end
	
	if OLD_PROXIMITY_LEFT > 0.95 and robot.proximity[4].value == 0 then
		proximity_left = OLD_PROXIMITY_LEFT
	else
		OLD_PROXIMITY_LEFT = robot.proximity[4].value
		proximity_left =  robot.proximity[4].value
	end
