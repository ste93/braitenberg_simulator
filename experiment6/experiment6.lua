...
function step()
	...
	proximity_right = (robot.proximity[21].value + robot.proximity[20].value + robot.proximity[22].value + robot.proximity[19].value + robot.proximity[23].value)/5

	proximity_left =  (robot.proximity[4].value + robot.proximity[5].value + robot.proximity[3].value + robot.proximity[2].value + robot.proximity[6].value)/5
